...
from .views import get_database_types, list_fuseki_datasets, create_database, get_type_predicates, generate_query, update_database
...
urlpatterns = [
    ...
    path('create_databse/', create_database, name='create_databse'),
